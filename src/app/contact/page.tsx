      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center items-center gap-6">
            ...
            <a href="https://github.com/pingmepi" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-smooth group">
              <div className="p-3 rounded-lg bg-accent group-hover:bg-primary/10 transition-smooth">
                <Image src="/assets/icons/github.svg" alt="GitHub" width={24} height={24} className="h-6 w-6" />
              </div>
              <span className="text-sm font-medium">GitHub</span>
            </a>
            <a href="https://www.instagram.com/theghostinphotographs/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-smooth group">
              <div className="p-3 rounded-lg bg-accent group-hover:bg-primary/10 transition-smooth">
